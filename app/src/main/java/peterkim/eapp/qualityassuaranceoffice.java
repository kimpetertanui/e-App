...
public class qualityassuaranceoffice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.qualityassuarance);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Quality Assuarance Assessment");
        ...
        if (wifi||net) {
            ...
            AlertDialog.Builder builder=new Builder(qualityassuaranceoffice.this);
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    qualityassuaranceoffice.this.finish();
    ...
    {
        //progress Dialog
        pd=new ProgressDialog(qualityassuaranceoffice.this);
